...
public class ExtendWeixinActivity extends BaseExtendActivity implements View.OnClickListener {
    ...
    private void requestData() {
        ...
        ExtendWeixinRequest request = new ExtendWeixinRequest();
        ...
        getSpiceManager().execute(request, new RequestListener<ExtendWeixinModelList>() {
            @Override
            ...
            @Override
            public void onRequestSuccess(ExtendWeixinModelList extendWeixinModelList) {
                initListView(extendWeixinModelList);
                cancelLoadingDialog();
            }
        });
    }

    private void initListView(List<ExtendWeixinModel> data) {
        adapter = AdapterLess.$recycle(this,
                data,
                R.layout.activity_extend_rss_list_item,
                new AdapterLess.RecycleCallBack<ExtendWeixinModel>() {
                    @Override
                    public void onBindViewHolder(int i, AdapterLess.RecycleViewHolder recycleViewHolder, ExtendWeixinModel extendWeixinModel) {
                        // set content
                        ...
                        recycleViewHolder.itemView.setOnClickListener(ExtendWeixinActivity.this);
                    }
                });
        recyclerView.setAdapter(adapter);
        recyclerView.addItemDecoration(new RecycleItemDecoration(ExtendWeixinActivity.this, RecycleItemDecoration.VERTICAL_LIST, getResources().getDrawable(R.drawable.recycleview_item_decoration)));
